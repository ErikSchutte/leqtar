...
test_that("arguments are correctly processed when parsing a genotypeFile and an expressionFile..", {
  ...
  expect_true( dir.exists( file.path(arguments$output, "leqtar", fsep=.Platform$file.sep) ), info = "Note: leqtar should exist in this scenario" )
  # Test if the genoToFreq flag works.
  expect_equal(arguments$genoToFreq, FALSE, info = "Note: genoToFreq should be FALSE in this scenario")
...
test_that("arguments are correctly processed when parsing a genotypeFile, an expressionFile, a covariatesFile and a specific output directory", {
  ...
  expect_true( dir.exists( file.path(arguments$output, "leqtar", "images", fsep=.Platform$file.sep) ), info = "Note: leqtar/images should exist in this scneario" )
  expect_true( dir.exists( file.path(arguments$output, "leqtar", "data", fsep=.Platform$file.sep) ), info = "Note: leqtar/data should exist in this scenario" )
  # Test if the genoToFreq flag works.
  expect_false(arguments$genoToFreq, info = "Note: genoToFreq should be FALSE in this scenario")
  # Test if the process_arguments function validated the arguments.
  expect_true(arguments$valid, info = "Note: valid should be TRUE in this scenario")
